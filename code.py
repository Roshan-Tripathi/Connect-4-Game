...
def introduction(startgame):
    ...
    label=font.render("LET'S PLAY Connect 4",1,(0,0,255))
    text_rect=label.get_rect(center=(int((COLUMNLENGTH*LENGTHOFBOX)/2), int(LENGTHOFBOX/2)))
    screen.blit(label, text_rect)
    mixer.music.load('Introduction_mario.mp3')
    mixer.music.play()
    ...
    while runit:
        ...
        for event in pygame.event.get():
            ...
            if event.type==MOUSEBUTTONDOWN:
                mouse=pygame.mouse.get_pos()
                if 200+400>mouse[0]>200 and 150+100>mouse[1]>150:
                    mixer.music.load('button_Click_mario.mp3')
                    mixer.music.play()
                    askdifficulty()
                    runit=False
                if 200+400>mouse[0]>200 and 350+100>mouse[1]>350:
                ...
                if turn == 1:
                    ...
                    if valid_location(board,user_input):
                        ...
                        if check_if_won(board,row,user_input):
                            pygame.draw.rect(screen,(0,0,0),(0,0,COLUMNLENGTH*LENGTHOFBOX,LENGTHOFBOX))
                            label=font.render("Red Player WINS!!!",1,(255,0,0))
                            text_rect=label.get_rect(center=(int((COLUMNLENGTH*LENGTHOFBOX)/2), int(LENGTHOFBOX/2)))
                            screen.blit(label, text_rect)
                            someone_won=True
                        turn=2
                    ...
                    if valid_location(board,user_input):
                        ...
                        if check_if_won(board,row,user_input):
                            pygame.draw.rect(screen,(0,0,0),(0,0,COLUMNLENGTH*LENGTHOFBOX,LENGTHOFBOX))
                            label=font.render("Green Player WINS!!!",1,(0,255,0))
                            text_rect=label.get_rect(center=(int((COLUMNLENGTH*LENGTHOFBOX)/2), int(LENGTHOFBOX/2)))
                            screen.blit(label, text_rect)
                            someone_won=True
                        turn=1
...
pygame.init()
pygame.display.set_caption("Let's Connect 4")
